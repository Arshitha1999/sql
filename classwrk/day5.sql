CREATE TABLE college.mobiles (id INT(50) NOT NULL AUTO_INCREMENT , brand VARCHAR(50) NOT NULL , model VARCHAR(50) NOT NULL , price INT(50) NOT NULL , stock INT(50) NOT NULL , PRIMARY KEY (id)) ENGINE = InnoDB;
